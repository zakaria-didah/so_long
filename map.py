...
#     """Checks if all coins are reachable from the player position."""
...
#             return
#         if visited[x][y] or grid[x][y] == '1':  # Wall or already visited
#             return
#         visited[x][y] = True
#         for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
#             dfs(x + dx, y + dy)
    
#     # Start DFS from the player position
#     dfs(*player_pos)
...
#         print("Usage: ./generate [VALID|INVALID]")
#         sys.exit(1)
    
#     validity = sys.argv[1]
#     rows, cols = int(sys.argv[2]), int(sys.argv[3])  # Example map size; you can adjust these
